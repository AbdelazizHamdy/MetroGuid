...
class StationsLine2Repo {
  static Line line2 = Line(
      2, [
    Stations(36, const LatLng(29.98157764595045, 31.21236761534283), "El-Mounib",transition.noTransition),
    Stations(37, const LatLng(29.995670327202305, 31.208623815926938,), "Sakiat Mekky",transition.noTransition),
    Stations(38, const LatLng(30.005858281815897, 31.20816311777667), "Omm El-Masryeen",transition.noTransition),
    Stations(39, const LatLng(30.010680139659943, 31.20727262436966), "El Giza",transition.noTransition),
    Stations(40, const LatLng(30.017257556258745, 31.20375356610484), "Faisal",transition.noTransition),
    Stations(41, const LatLng(30.025973442800126, 31.201097720618147), "Cairo University",transition.noTransition),
    Stations(42, const LatLng(30.03579144205223, 31.20013212536856), "El Bohoth",transition.noTransition),
    ...
    Stations(46, const LatLng(30.045360220754606, 31.244197235853093), "Mohamed Naguib",transition.noTransition),
    Stations(47, const LatLng(30.05232674717125, 31.24679796940866), "Attaba",transition.secondToThird),
    Stations(48, const LatLng(30.061110260498065, 31.246033564629567), "Al-Shohadaa",transition.firstToSecond),
    Stations(49, const LatLng(30.07085020223823, 31.245171470664403), "Masserra",transition.noTransition),
    Stations(50, const LatLng(30.08069648804761, 31.245435058538668), "Road El-Farag",transition.noTransition),
    Stations(51, const LatLng(30.087962970433026, 31.245524069472648), "Saint Teresa",transition.noTransition),
    Stations(52, const LatLng(30.09735511570416, 31.245534952108464), "Khalafawy",transition.noTransition),
    Stations(53, const LatLng(30.10416595979361, 31.2456579597874), "Mezalat",transition.noTransition),
    Stations(54, const LatLng(30.113682112027725, 31.248618930061692), "Koliet El-zrea",transition.noTransition),
    Stations(55, const LatLng(30.12233757908951, 31.244384268216425), "Shobra Elkhiema",transition.noTransition),
  ]);
